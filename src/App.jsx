...
function Login() {
  ...
  return <Layout><main className="content">
    ...
    <form className="mt-7 space-y-4" onSubmit={enter}>
      <label className="block text-sm font-bold text-ink">Email<input className="field" type="email" required placeholder="you@example.com" autoComplete="email" /></label>
      <label className="block text-sm font-bold text-ink">Password<input className="field" type="password" required placeholder="Your password" autoComplete="current-password" /></label>
